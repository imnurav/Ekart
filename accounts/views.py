...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(
            #     request, 'Thank you for registering with us. We have sent you a verification email to your email address [nurav0402@gmail.com]. Please verify it.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # print(cart_item)
                    # getting the product_variation by cart id
                    product_variation = []
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                messages.error(request, "Please enter currect password")
                return redirect('change_password')
        else:
            messages.error(request, "Password Does not Match.")
            return redirect('change_password')
